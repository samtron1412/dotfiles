function! log#log_autocmds_toggle()
  augroup LogAutocmd
    autocmd!
  augroup END
  ...
  if !s:activate
    echom 'Stopped autocmd log (' . l:date . ') at /tmp/vim_log_autocommands'
    call s:log('Stopped autocmd log (' . l:date . ')')
    return
  endif

  echom 'Started autocmd log (' . l:date . ') at /tmp/vim_log_autocommands'
